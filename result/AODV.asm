...
definitions:
	...
	/* START PAR */
			...
			receivedReq(host2):=[(1,host4),(1,host2)]
			receivedReq(host4):=[(1,host4)]
			receivedReq(host5):=[(1,host5),(1,host4),(2,host5)]
			receivedReq(host6):=[(1,host4),(1,host5),(1,host6)]
			...
			waitingForRouteToTmp(host2,host1):=5
			waitingForRouteToTmp(host2,host3):=5
			waitingForRouteToTmp(host2,host5):=5
			waitingForRouteToTmp(host4,host2):=2
			waitingForRouteToTmp(host4,host6):=2
			waitingForRouteToTmp(host5,host1):=5
			waitingForRouteToTmp(host5,host4):=3
			waitingForRouteToTmp(host5,host6):=3
			waitingForRouteToTmp(host6,host2):=5
			waitingForRouteToTmp(host6,host3):=5

			extend RoutingTable with $_rt1,$_rt2,$_rt3,$_rt4,$_rt5 do
				par
									active($_rt1):=true
					active($_rt2):=true
					active($_rt3):=true
					active($_rt4):=true
					active($_rt5):=true
					entry($_rt1):=(host4,1,1,host4)
					entry($_rt2):=(host4,1,1,host4)
					entry($_rt3):=(host4,1,2,host6)
					entry($_rt4):=(host5,1,1,host5)
					entry($_rt5):=(host2,0,1,host2)
					entryFor(host2):=undef
					entryFor(host4):=undef
					entryFor(host5):=undef
					entryFor(host6):=$_rt1
					owner($_rt1):=host6
					owner($_rt2):=host2
					owner($_rt3):=host5
					...
					precursor($_rt5):=[]
				endpar
			extend Message with $_message1,$_message2,$_message3,$_message4,$_message5,$_message6,$_message7,$_message8,$_message9,$_message10,$_message11,$_message12,$_message13,$_message14,$_message15 do
				par
									isConsumed(host1,$_message10):=false
					isConsumed(host1,$_message11):=false
					isConsumed(host1,$_message13):=false
					isConsumed(host1,$_message14):=false
					isConsumed(host1,$_message15):=false
					...
					isConsumed(host3,$_message12):=false
					isConsumed(host3,$_message13):=false
					isConsumed(host3,$_message14):=false
					isConsumed(host3,$_message15):=false
					isConsumed(host4,$_message10):=false
					isConsumed(host4,$_message11):=false
					isConsumed(host4,$_message12):=false
					isConsumed(host4,$_message13):=false
					isConsumed(host4,$_message14):=false
					isConsumed(host4,$_message15):=false
					isConsumed(host4,$_message5):=true
					isConsumed(host4,$_message6):=true
					isConsumed(host5,$_message10):=false
					...
					isConsumed(host5,$_message5):=true
					isConsumed(host5,$_message8):=false
					isConsumed(host6,$_message1):=true
					isConsumed(host6,$_message12):=false
					isConsumed(host6,$_message2):=true
					isConsumed(host6,$_message3):=true
					isConsumed(host6,$_message4):=true
					isConsumed(host6,$_message7):=false
					isConsumed(host6,$_message9):=false
					messageRREP($_message6):=(host4,0,host2,0,host2)
					messageRREP($_message8):=(host5,1,host4,1,host6)
					messageRREQ($_message1):=(host4,1,0,host6,undef,1,host4)
					messageRREQ($_message10):=(host6,1,0,host3,undef,1,host6)
					messageRREQ($_message11):=(host6,1,0,host2,undef,1,host6)
					messageRREQ($_message12):=(host1,1,0,host5,undef,1,host1)
					messageRREQ($_message13):=(host2,1,0,host5,undef,1,host2)
					messageRREQ($_message14):=(host2,1,0,host1,undef,1,host2)
					messageRREQ($_message15):=(host2,1,0,host3,undef,1,host2)
					messageRREQ($_message2):=(host4,1,0,host2,undef,1,host4)
					messageRREQ($_message3):=(host5,1,0,host4,undef,1,host5)
					messageRREQ($_message4):=(host5,1,0,host6,undef,1,host5)
					messageRREQ($_message5):=(host4,1,1,host2,undef,1,host6)
					messageRREQ($_message7):=(host4,1,2,host2,undef,1,host5)
					messageRREQ($_message9):=(host5,2,0,host1,undef,2,host5)
